! function (root, factory) {
    "object" == typeof exports && "object" == typeof module ? module.exports = factory(require("VueClickaway")) : "function" == typeof define && define.amd ? define(["VueClickaway"], factory) : "object" == typeof exports ? exports.VueInstant = factory(require("VueClickaway")) : root.VueInstant = factory(root.VueClickaway)
    ...
    return function (modules) {
        ...
        var Component = __webpack_require__(5)(__webpack_require__(3), __webpack_require__(6), null, null);
        ...
        Object.defineProperty(__webpack_exports__, "__esModule", {
            ...
            function (global) {
                ...
                var __WEBPACK_IMPORTED_MODULE_0__components_VueInstant_vue__ = __webpack_require__(1),
                    __WEBPACK_IMPORTED_MODULE_0__components_VueInstant_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__components_VueInstant_vue__);
                __webpack_require__.d(__webpack_exports__, "VueInstant", function () {
        ...
        var __WEBPACK_IMPORTED_MODULE_0_vue_clickaway__ = __webpack_require__(7);
        ...
        __webpack_exports__.default = {
            ...
            methods: {
                ...
                setSelectedAsTextValue: function () {
                    this.textVal = this.selected
                },
                setInitialTextValue: function () {
                    this.textVal = this.value
                },
                setFinalTextValue: function () {
                    this.finalTextValueValidation() ? (this.setPlaceholderAndTextVal(), this.emitChange()) : this.clearAll()
                },
                setPlaceholderAndTextVal: function () {
                    if (void 0 !== this.similiarData[this.highlightedIndex]) {
                        var suggest = this.similiarData[this.highlightedIndex];
                        this.placeholderVal = suggest[this.suggestionAttribute], this.textVal = suggest[this.suggestionAttribute], this.selectedSuggest = suggest, this.emitSelected()
                    }
                },
                setInitialPlaceholder: function () {
                ...
                emitChange: function () {},
                emitClickInput: function (event) {
                    this.$emit("click-input", event)
                },
                emitClickButton: function (event) {
        ...
        module.exports = {
            render: function () {
                ...
                return _c("div", [_c("div", {
                    ...
                    class: _vm.getClassInputPlaceholder,
                    attrs: {
                        type: "search",
                        name: "search",
                ...
                }, _vm._l(_vm.similiarData, function (item, index) {
                    return _c("li", {
